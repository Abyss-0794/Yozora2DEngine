...
private:
	...
	std::array<ComPtr<ID3D12PipelineState>, static_cast<size_t>(PSOType::COUNT_PSO)> m_fixedPsoArray;			// ŒÅ’èŽí—Þ—pPSO
	std::array<ComPtr<ID3D12RootSignature>, static_cast<size_t>(ROOTSIGType::COUNT_ROOTSIG)> m_fixedrootSignatureArray;	// ŒÅ’èŽí—Þ—pRS
